...
From §1.4: _Charset Alias Matching_
...
> 1. Map uppercase A-Z to the corresponding lowercase a-z.
> 1. From left to right, delete each 0 that is not preceded by a digit.
>
